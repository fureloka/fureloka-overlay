...
inherit autotools eutils fdo-mime gnome2-utils l10n multilib multilib-minimal pax-utils toolchain-funcs versionator
...
SRC_URI="${SRC_URI}
	https://dl.winehq.org/wine/source/3.0/${P}.tar.xz
	gecko? (
...
LICENSE="LGPL-2.1"
SLOT="0"
IUSE="+abi_x86_32 +abi_x86_64 +alsa capi cups dos elibc_glibc +fontconfig +gecko gphoto2 gsm gstreamer +jpeg kerberos +lcms ldap +mono mp3 ncurses netapi nls odbc openal opencl +opengl osmesa oss +perl pcap pipelight +png prelink pulseaudio +realtime +run-exes s3tc samba scanner selinux +ssl test +threads +truetype udev +udisks v4l +X +xcomposite xinerama +xml"
...
multilib_src_install_all() {
	...
	for l in de fr pl; do
		has ${l} ${LINGUAS-${1}} || rm -r "${D}"usr/share/man/${l}*
	done
}
